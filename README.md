# Applied-statistics-Master_degree
...
- Вывод для высокоразмерных и неструктурированных данных
- Оценка доверия: bootstrap, permutation, cross-validation
- Интерпретация: feature importance, SHAP, causal inference
